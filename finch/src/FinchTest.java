...
public class FinchTest implements KeyListener, MouseInputListener, WindowListener {
    ...
    private int[] motorSpeed = {0, 0}; //left motor speed, right motor speed
    private int driveSpeed = 50;
    private int turnSpeed = driveSpeed / 2;

    public FinchTest(int width, int height) {
        // this.finch = finch;
        frame = new JFrame();
